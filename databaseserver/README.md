...
- MongoDB multi-document ACID transactions for 3 functions. See `MongoDBMbotRepository.saveAll()`.
- MongoDB Aggregation pipeline. See `MongoDBMbotRepository.getAverageAge()`.
- Implementation of basic CRUD queries. See `MongoDBMbotRepository.java`.
